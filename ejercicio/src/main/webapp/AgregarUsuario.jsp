                        ...
                        <div class="fondo-formularios">
                            <div class="formularios">
                                ...
                                <form class="form">
                                    ...
                                    <p type="Correo:"><input placeholder="Escribe tu correo aqui.."></input></p>
                                    <p type="Numero:"><input placeholder="Escribe tu numero aqui.."></input></p>                                    
                                    <p type="Usuario:"><input placeholder="Escribe tu usuario aqui.."></input></p>
                                    <p type="Contraseña:"><input placeholder="Escribe tu contrasena aqui.." type="password"></input></p>
