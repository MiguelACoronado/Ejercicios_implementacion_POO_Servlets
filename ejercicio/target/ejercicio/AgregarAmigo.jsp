                     ...
                     <div class="contenedor-nombre-cuenta">
                        ...
                        <div class="fondo-formularios">
                            <div class="formularios">
                                ...
                                <form class="form">
                                    <h2>Agregar Amigo</h2>
                                    <p type="Nombre:"><input placeholder="Escribe nombre de tu amigo aqui.."></input></p>
                                    <p type="Numero:"><input placeholder="Escribe numero de tu amigo aqui.."></input></p> 
                                    <p type="Usuario:"><input placeholder="Escribe usuario de tu amigo aqui.."></input></p>                                                                     
